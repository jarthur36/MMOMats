...
public class ItemStoneMat extends ItemMM {
    static final String[] STONE_MAT_NAMES = new String[] { "Stone Sliver" , "Rough Stone" , "Stone" , "Rounded Stone" , "Polished Stone" , "Refined Stone" };
    ...
    public void registerIcons(IconRegister iconRegister) {
        ...
        icons = new Icon[STONE_MAT_NAMES.length];

        for (int i = 0; i < STONE_MAT_NAMES.length; ++i) {
