...
public class GuiForge extends GuiContainer {
    ...
    public GuiForge(InventoryPlayer inventoryPlayer, TileHearth tileHearth) {
        super(new ContainerForge(inventoryPlayer, tileHearth));
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2,
        ...
        mc.renderEngine.bindTexture(Textures.GUI_FORGE);
